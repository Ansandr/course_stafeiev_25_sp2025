...
neg_and_done:
    ...
    cmp eax, 0
    jz LABEL@AFTER_THEN_0000000002BD2F10
    ...
    mov eax, 1
LABEL@AFTER_THEN_0000000002BD2F10:

    ;"else"
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_0000000002BD5050
    ...
    ;"else"
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_0000000002BDA370
    ...
    ;";" (after "else")
LABEL@AFTER_ELSE_0000000002BDA370:
    ...
    ;after cond expresion (after "if")
    cmp eax, 0
    jz LABEL@AFTER_THEN_0000000002BE2870
    ...
    ;";" (after "then"-part of if-operator)
    mov eax, 1
LABEL@AFTER_THEN_0000000002BE2870:

    ;"else"
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_0000000002BE4588
    ...
    ;";" (after "else")
LABEL@AFTER_ELSE_0000000002BE4588:
    ...
    ;after cond expresion (after "if")
    cmp eax, 0
    jz LABEL@AFTER_THEN_0000000002BEA0F8
    ...
    ;";" (after "then"-part of if-operator)
    mov eax, 1
LABEL@AFTER_THEN_0000000002BEA0F8:

    ;"else"
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_0000000002BEC660
    ...
    ;";" (after "else")
LABEL@AFTER_ELSE_0000000002BEC660:
    ...
    ;after cond expresion (after "if")
    cmp eax, 0
    jz LABEL@AFTER_THEN_0000000002BF0D08
    ...
    ;";" (after "then"-part of if-operator)
    mov eax, 1
LABEL@AFTER_THEN_0000000002BF0D08:

    ;"else"
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_0000000002BF2A20
    ...
    ;";" (after "else")
LABEL@AFTER_ELSE_0000000002BF2A20:
